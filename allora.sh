...
echo -e "\n Подписаться на мой канал Beloglazov invest, чтобы быть в курсе самых актуальных нод и активностей - https://t.me/beloglazovinvest\n"
...
EOL
            ...
            ;;
        2)
            echo "Через 60 секунд пойдут логи. Для выхода из отображения логов нажмите CTRL+C. Пока Вы можете подписаться на мой канал Beloglazov invest, чтобы быть в курсе самых актуальных нод и активностей - https://t.me/beloglazovinvest\n"
            sleep 60
